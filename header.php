    ...
    <nav class="flex flex-col sm:flex-row">
        <ul class="flex justify-end items-center space-x-6">
            <?php if ($_SESSION["kanri_flg"] == 1) : ?>
                <li class="text-base hover:text-white hover:bg-yellow-500"><a href="input.php">スケジュール登録</a></li>
            <?php endif; ?>
            <li class="text-base hover:text-white hover:bg-yellow-500"><a href="select.php">スケジュール一覧</a></li>
            <?php if ($_SESSION["kanri_flg"] == 1) : ?>
                <li class="text-base hover:text-white hover:bg-yellow-500"><a href="user.php">ユーザー登録</a></li>
                <li class="text-base hover:text-white hover:bg-yellow-500"><a href="user_list.php">ユーザー一覧</a></li>
            <?php endif; ?>
